...
CREATE TABLE RESERVE (
	...
	EVENT_CODE     VARCHAR(20)    NULL,     -- 종목코드
...
-- 종목
CREATE TABLE EVENT (
	EVENT_CODE  VARCHAR(20)    NOT NULL, -- 종목코드
...
--VALUES ('BASKETBALL','농구');
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('DIVING','다이빙',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SPRINT','단거리경주',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('BILLIARDS','당구',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('RUGBY','럭비',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('FOOTBALL ','미식축구',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('VOLLEYBAL ','배구',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('BADMINTON ','배드민턴',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('BOWLING','볼링',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SOFTBALL','소프트볼',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SWIMMING','수영',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SNOWBOARD','스노보드',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SKATE','스케이트',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SKATEBOARD','스케이트보드',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SKI','스키',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('HORSEBACK RIDING','승마',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('CYCLING','싸이클링',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('BASEBALL ','야구',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('ARCHERY','양궁',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('GYMNASTICS','체조',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('SOCCER','축구',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('TABLE TENNIS','탁구',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('TENNIS','테니스',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('FENCING','펜싱',10000,20);
--INSERT INTO EVENT(EVENT_CODE,EVENT_NAME,EVENT_PRICE,EVENT_MAX)
--VALUES ('HOCKEY','하키',10000,20);
