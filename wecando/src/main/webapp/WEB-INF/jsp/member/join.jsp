					...
					<div class="row mt">
						<div class="col-lg-12">
							<div class="form-panel-email">
								...
								<div id='passwordForm' class="join_form has-feedback">
								...
								<div id='password2Form' class="join_form">
								...
								<div id='nameForm' class="join_form">
									<label class="col-sm-2 col-sm-2 control-label"> 이름</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="m_name">
									</div>
								</div>
								<div id='nickForm' class="join_form">
								...
								<div id="telForm" class="join_form">
